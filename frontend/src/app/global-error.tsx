          ...
          <div className="container mx-auto max-w-2xl text-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-4 leading-relaxed">
                Our genie encountered an unexpected problem. Don&apos;t worry, 
                these things happen even in the most magical of applications!
              </p>
            ...
            >
              <p className="text-sm text-muted-foreground">
                If this problem persists, please refresh the page or contact our support team.
